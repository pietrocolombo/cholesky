...
plt.plot( 'name', 'time', data=python_win, marker='o', markerfacecolor='blue', markersize=12, color='skyblue', linewidth=4, label='time Python Windows')
plt.plot( 'name', 'time', data=python_ubuntu, marker='o', markerfacecolor='red', markersize=12, color='orange', linewidth=4, label='time Python Ubuntu', linestyle='--')

...
plt.plot( 'name', 'time', data=matlab_ubuntu, marker='o', markerfacecolor='orange', markersize=6, color='orange', linewidth=2, label='time Matlab Ubuntu')
plt.plot( 'name', 'time', data=python_ubuntu, marker='o', markerfacecolor='gold', markersize=6, color='gold', linewidth=2, label='time Python Ubuntu')
plt.plot( 'name', 'time', data=r_ubuntu, marker='o', markerfacecolor='red', markersize=6, color='red', linewidth=2, label='time R Ubuntu')

...
plt.plot( 'name', 'time', data=python_win, marker='o', markerfacecolor='gold', markersize=6, color='gold', linewidth=2, label='time Python Windows')
plt.plot( 'name', 'time', data=r_win, marker='o', markerfacecolor='red', markersize=6, color='red', linewidth=2, label='time R Windows')

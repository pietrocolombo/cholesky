...
bar5 = plt.bar(pos+barWidth * 4, mem_bef_matlab_win, width = barWidth, color = 'g', label='Matlab before ubuntu')
bar6 = plt.bar(pos+barWidth * 5, mem_after_matlab_win, width = barWidth, color = 'y', label='Matlab after ubuntu')

...
plt.plot( 'name', 'relative_error', data=r_win, marker='o', markerfacecolor='blue', markersize=12, color='skyblue', linewidth=4, label='Relative error R Windows')
plt.plot( 'name', 'relative_error', data=r_ubuntu, marker='o', markerfacecolor='red', markersize=12, color='orange', linewidth=4, label='Relative error R Ubuntu', linestyle='--')

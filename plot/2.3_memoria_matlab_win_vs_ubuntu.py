...
bar1 = plt.bar(pos, mem_bef_matlab_win, width = barWidth, color = 'r', label='Matlab win before')
bar2 = plt.bar(pos+barWidth, mem_after_matlab_win, width = barWidth, color = 'b', label='Matlab win after')

bar3 = plt.bar(pos+barWidth+barWidth, mem_bef_matlab_ubuntu, width = barWidth, color = 'g', label='Matlab Ubuntu before')
bar4 = plt.bar(pos+barWidth+barWidth+barWidth, mem_after_matlab_ubuntu, width = barWidth, color = 'y', label='Matlab Ubuntu after')

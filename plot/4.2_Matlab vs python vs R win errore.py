...
plt.plot( 'name', 'relative_error', data=matlab_win, marker='o', markerfacecolor='orange', markersize=6, color='orange', linewidth=2, label='relative error Matlab Windows')
plt.plot( 'name', 'relative_error', data=python_win, marker='o', markerfacecolor='gold', markersize=6, color='gold', linewidth=2, label='relative error Python Windows')
plt.plot( 'name', 'relative_error', data=r_win, marker='o', markerfacecolor='red', markersize=6, color='red', linewidth=2, label='relative error R Windows')

...
plt.plot( 'name', 'error', data=matlab_win, marker='o', markerfacecolor='blue', markersize=12, color='skyblue', linewidth=4, label='Relative error Python Windows')
plt.plot( 'name', 'error', data=matlab_ubuntu, marker='o', markerfacecolor='red', markersize=12, color='orange', linewidth=4, label='Relative error Python Ubuntu', linestyle='--')

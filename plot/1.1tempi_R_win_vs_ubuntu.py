...
plt.plot( 'name', 'time', data=r_win, marker='o', markerfacecolor='orange', markersize=6, color='orange', linewidth=2, label='time R Windows')
plt.plot( 'name', 'time', data=r_ubuntu, marker='o', markerfacecolor='gold', markersize=6, color='gold', linewidth=2, label='time R Ubuntu')
